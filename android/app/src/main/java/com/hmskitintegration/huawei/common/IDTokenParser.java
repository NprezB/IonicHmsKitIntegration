 ...
 */
package com.hmskitintegration.huawei.common;
...
public class IDTokenParser {
     ...
     */
    public void verify(String idToken, ICallBack callBack) throws InvalidPublicKeyException, JWTDecodeException {
        ...
        getRSAPublicKeyByKidAsyn(decoder.getKeyId(), new ICallBack() {
            ...
            public void onSuccess() {
                try {
                    ...
                    Log.i(TAG, "Exception captured:" + e.getClass().getSimpleName());
                    callBack.onFailed();
     ...
     * @throws InvalidPublicKeyException throw when InvalidPublicKeyException happened
     */
    private void getRSAPublicKeyByKidAsyn(String keyId, ICallBack callBack) throws InvalidPublicKeyException {
