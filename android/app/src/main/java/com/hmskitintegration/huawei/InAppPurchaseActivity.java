...
import com.hmskitintegration.huawei.common.CipherUtil;
import com.hmskitintegration.huawei.common.Key;
...
public class InAppPurchaseActivity extends Activity {
    ...
    private void loadProduct() {
        ...
        IapClient iapClient = Iap.getIapClient(InAppPurchaseActivity.this);
            ...
            public void onFailure(Exception e) {
                ...
                if (e instanceof IapApiException) {
                    ...
                    if (returnCode == OrderStatusCode.ORDER_HWID_NOT_LOGIN) {
                        Toast.makeText(InAppPurchaseActivity.this, "Please sign in to the app with a HUAWEI ID.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(InAppPurchaseActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(InAppPurchaseActivity.this, "error", Toast.LENGTH_SHORT).show();
                }
    ...
    private ProductInfoReq createProductInfoReq() {
        ...
        productIds.add("testGems0000");
        productIds.add("cptest0001");
    ...
    private void showProduct(List<ProductInfo> productInfoList) {
        ...
        SimpleAdapter simAdapter = new SimpleAdapter(
                InAppPurchaseActivity.this, products, R.layout.item_layout,
                new String[]{item_image, item_name, item_price, item_description}, new int[]{
                R.id.item_image, R.id.item_name, R.id.item_price, R.id.item_description});
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int pos, long l) {
                String productId = (String) products.get(pos).get(InAppPurchaseActivity.this.item_productId);
                gotoPay(InAppPurchaseActivity.this, productId, IapClient.PriceType.IN_APP_CONSUMABLE);
            }
        });
