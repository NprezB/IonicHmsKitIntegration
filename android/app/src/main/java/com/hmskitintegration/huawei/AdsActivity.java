...
import com.hmskitintegration.huawei.adsutils.AdFormat;
import com.hmskitintegration.huawei.adsutils.AdSampleAdapter;
import com.hmskitintegration.huawei.adsutils.AdsConstant;
import com.hmskitintegration.huawei.adsutils.BannerActivity;
import com.hmskitintegration.huawei.adsutils.ConsentActivity;
import com.hmskitintegration.huawei.adsutils.NativeActivity;
import com.hmskitintegration.huawei.adsutils.ProtocolActivity;
import com.hmskitintegration.huawei.adsutils.RewardActivity;
import com.hmskitintegration.huawei.adsutils.dialogs.ConsentDialog;
...
public class AdsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AdSampleAdapter adapter = new AdSampleAdapter(AdsActivity.this, android.R.layout.simple_list_item_1, adFormats);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener((parent, view, position, id) -> {
            AdFormat adFormat = adapter.getItem(position);
            assert adFormat != null;
